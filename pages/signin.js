  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-2 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 data-test="signin-title" className="mt-6 text-center text-3xl font-extrabold text-gray-900">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form data-test="signin-form" className="space-y-6" action="#" method="POST">
            <div>
              <label
                htmlFor="email"
